...
function contactOnDiscord() {
    navigator.clipboard.writeText('crazyfellow').then(() => {
        ...
        </svg><span class="discord-text">✓ Username copied! Search for <strong>crazyfellow</strong> in Discord<br><span style="font-size: 0.8em; opacity: 0.8;">✓ ユーザー名をコピーしました！Discordで crazyfellow を検索</span></span>`;
